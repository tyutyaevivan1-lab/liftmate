...
- "lose_weight" → 3 подхода × 12-20 повторений, минимальный отдых между подходами (30-45 секунд — упомяни это в why). ПРИОРИТЕТ многосуставным/функциональным движениям и упражнениям с высоким расходом энергии в рамках указанного muscle_focus (выпады, берпи, приседания с прыжком, скакалка — если доступна по оборудованию, круговые связки). Избегай тяжёлых силовых базовых движений в силовом стиле (жим штанги на максимальный рабочий вес, становая тяга с большим весом) — если включаешь похожие движения (жим, тяга, присед), используй вариации с собственным весом или лёгким весом на высокое количество повторений, а не силовой акцент.
